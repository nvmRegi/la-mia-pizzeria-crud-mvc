...
namespace La_Mia_pizzeria_static.Utils
{
    public static class MenùData
    {
        ...
        public static List<Pizza> GetPizze()
        {
            ...
            //Pizze default
            Pizza pizza = new Pizza("Marinara", "Pomodoro - origano - aglio - olio", "pizza-marinara.jpg", 4);
            nuovaListaPizza.Add(pizza);

            Pizza pizza1 = new Pizza("Margherita", "Pomodoro - mozzarella", "pizza-g7672da356_640.jpg", 5);
            nuovaListaPizza.Add(pizza1);

            Pizza pizza2 = new Pizza("Funghi", "Pomodoro - mozzarella - funghi champignon", "pizza-funghi.jpg", 6);
